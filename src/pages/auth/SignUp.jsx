        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-base-100 rounded-2xl shadow-2xl p-6 animate-in fade-in zoom-in duration-300 border border-base-300">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-bold text-base-content">Verify Your Email</h3>
            ...
            <div className="mt-6 pt-4 border-t border-base-300">
              <p className="text-xs text-base-content/50 text-center">The OTP will expire in 10 minutes</p>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-7">
              ...
              <div className="mb-8">
                ...
                <h2 className="text-xl font-bold text-base-content mt-6">Create Account</h2>
              ...
              <form onSubmit={handleSignUp} className="space-y-5">
                ...
                <div className="form-control">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full pl-11 h-11 ${errors.fullName ? 'input-error' : ''}`}
                ...
                <div className="form-control">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative flex-1">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <Mail className={`w-5 h-5 ${loading.sendingOtp ? 'text-primary animate-pulse' : 'text-base-content/40'}`} />
                      </div>
                      <input
                        type="email"
                        name="email"
                ...
                <div className="form-control">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="label-text-alt text-base-content/70">Min. 6 characters</span>
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="form-control">
                  <label className="label cursor-pointer justify-start gap-3 hover:bg-base-200 p-2 rounded-lg transition-colors">
                    ...
                    <span className="label-text text-base-content">
                      I agree to the <a href="#" className="link link-primary font-medium">Terms</a> and{" "}
                      <a href="#" className="link link-primary font-medium">Privacy Policy</a>
                    </span>
                  </label>
                </div>
                ...
                <button 
                  type="submit" 
                  className={`btn btn-primary w-full h-11 ${loading.signingUp ? 'loading' : ''} 
                    ${!otpVerified ? 'btn-disabled' : ''}`} 
                ...
                <button
                  ...
                  className={`btn btn-outline w-full h-11 ${loading.googleSignup ? 'loading' : ''}`}
                ...
                >
                  ...
                  {loading.googleSignup ? "Signing up..." : "Sign up with Google"}
                </button>
            ...
            <div className="hidden lg:flex w-1/2 items-center justify-center bg-gradient-to-br from-primary/10 via-primary/5 to-secondary/5 p-7">
              <div className="text-center max-w-xs mx-auto">
                ...
                <h3 className="text-lg font-bold text-base-content mb-3">Secure Fund Management</h3>
                ...
                <div className="p-4 bg-base-100/50 backdrop-blur-sm rounded-lg border border-base-200">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="text-left">
                      <h4 className="font-semibold text-base-content text-sm mb-1">Secure Verification</h4>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <h4 className="font-semibold text-base-content text-sm mb-1">Quick Signup</h4>
                      <p className="text-xs text-base-content/70">
